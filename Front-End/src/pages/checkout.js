                  ...
                  <div className="border-b border-gray-900/10 pb-12">
                    <div className="flex justify-between">
                      ...
                      <button
                        ...
                        type="button"
                        className="flex gap-1 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        <svg
                        ...
                        <span className="pt-1">Add Address</span>
                      </button>
                    </div>
                    ...
                    <ul>
                      {user.addresses.map((address, index) => (
                        <li
                          key={index}
                          className="mb-5 flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200"
                        >
